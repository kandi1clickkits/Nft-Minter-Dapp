...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/Nft-Minter-Dapp/releases/download/v1.0.0/Nft-Minter-Dapp.zip
SET REPO_NAME=Nft-Minter-Dapp.zip
SET EXTRACTED_REPO_DIR=Nft-Minter-Dapp
SET NOTEBOOK_NAME=nft__minting.bat
where /q node
IF ERRORLEVEL 1 (
	ECHO==========================================================================
